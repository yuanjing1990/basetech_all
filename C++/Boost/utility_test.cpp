...
class base_class1 {
  public:
    explicit base_class1(int i) : _member(i) {
...
class base_class2 {
  public:
    explicit base_class2(base_class1 &val) : _member(val._member) {
...
class user_class : private boost::base_from_member<base_class1>,
                   public base_class2 {
