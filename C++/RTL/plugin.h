...
typedef struct _LOAD_FILE_INFO {
    size_t nSize;          // sizeof( LOAD_FILE_INFO )
    UINT nCP;
    BOOL bDetectUnicode;
    BOOL bDetectAll;
    BOOL bDetectCharset;
...
typedef struct _LOAD_FILE_INFO_EX {
    size_t nSize;          // sizeof( LOAD_FILE_INFO_EX )
    UINT nCP;
    BOOL bDetectUnicode;
    BOOL bDetectAll;
    BOOL bDetectCharset;
...
typedef struct _GREP_INFOW {
    size_t  nSize;         // sizeof( GREP_INFOW )
    UINT    nCP;
    UINT    nFlags;
    LPCWSTR pszFind;
    LPCWSTR pszReplace;
...
typedef struct _GREP_INFOA {
    size_t  nSize;         // sizeof( GREP_INFOA )
    UINT    nCP;
    UINT    nFlags;
    LPCSTR  pszFind;
    LPCSTR  pszReplace;
...
#ifdef EE_STRICT
inline BOOL Editor_LoadFileA( HWND hwnd, LOAD_FILE_INFO_EX* plfi, LPSTR szFileName )
{
    return (BOOL)SNDMSG( (hwnd), EE_LOAD_FILEA, (WPARAM)plfi, (LPARAM)(LPSTR)(szFileName) );
}
#else
#define Editor_LoadFileA( hwnd, plfi, szFileName ) \
    (BOOL)SNDMSG( (hwnd), EE_LOAD_FILEA, (WPARAM)(LOAD_FILE_INFO_EX*)plfi, (LPARAM)(LPSTR)(szFileName) )
#endif
...
#ifdef EE_STRICT
inline BOOL Editor_LoadFileW( HWND hwnd, LOAD_FILE_INFO_EX* plfi, LPWSTR szFileName )
{
    return (BOOL)SNDMSG( (hwnd), EE_LOAD_FILEW, (WPARAM)plfi, (LPARAM)(LPWSTR)(szFileName) );
}
#else
#define Editor_LoadFileW( hwnd, plfi, szFileName ) \
    (BOOL)SNDMSG( (hwnd), EE_LOAD_FILEW, (WPARAM)(LOAD_FILE_INFO_EX*)plfi, (LPARAM)(LPWSTR)(szFileName) )
#endif
...
#ifdef EE_STRICT
inline void Editor_InsertStringA( HWND hwnd, LPCSTR szString )
{
    SNDMSG( (hwnd), EE_INSERT_STRINGA, (WPARAM)OVERWRITE_PER_PROP, (LPARAM)(LPCSTR)(szString) );
}
#else
...
#ifdef EE_STRICT
inline void Editor_InsertA( HWND hwnd, LPCSTR szString )
{
    SNDMSG( (hwnd), EE_INSERT_STRINGA, (WPARAM)OVERWRITE_INSERT, (LPARAM)(LPCSTR)(szString) );
}
#else
...
#ifdef EE_STRICT
inline void Editor_OverwriteA( HWND hwnd, LPCSTR szString )
{
    SNDMSG( (hwnd), EE_INSERT_STRINGA, (WPARAM)OVERWRITE_OVERWRITE, (LPARAM)(LPCSTR)(szString) );
}
#else
...
#ifdef EE_STRICT
inline void Editor_InsertStringW( HWND hwnd, LPCWSTR szString )
{
    SNDMSG( (hwnd), EE_INSERT_STRINGW, (WPARAM)OVERWRITE_PER_PROP, (LPARAM)(LPCWSTR)(szString) );
}
#else
...
#ifdef EE_STRICT
inline void Editor_InsertW( HWND hwnd, LPCWSTR szString )
{
    SNDMSG( (hwnd), EE_INSERT_STRINGW, (WPARAM)OVERWRITE_INSERT, (LPARAM)(LPCWSTR)(szString) );
}
#else
...
#ifdef EE_STRICT
inline void Editor_OverwriteW( HWND hwnd, LPCWSTR szString )
{
    SNDMSG( (hwnd), EE_INSERT_STRINGW, (WPARAM)OVERWRITE_OVERWRITE, (LPARAM)(LPCWSTR)(szString) );
}
#else
...
#define MAX_MONITOR_INTERVAL            255
#define DEF_MONITOR_INTERVAL            2
