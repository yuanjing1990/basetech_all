...
template <class T> class NewHandlerSupport {
  public:
...
template <class T> void *NewHandlerSupport<T>::operator new(size_t size) {
...
template <class T> new_handler NewHandlerSupport<T>::currentHandler = 0;
